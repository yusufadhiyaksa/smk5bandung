    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-item  @if(request()->routeIs('jurusan*')) active @endif">
                ...
                <li
                    class="sidebar-item has-sub  @if(request()->routeIs('kelas*')) active @endif">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu ">
                        @foreach(Jurusan::all() as $jurusan)
                            <li class="submenu-item  ">
                                <a href="{{route('kelas.index', $jurusan->id)}}" class="submenu-link">{{$jurusan->nama_jurusan}}</a>
                            </li>
                        @endforeach
                    </ul>
                </li>
                <li
                    class="sidebar-item  has-sub  @if(request()->routeIs('mapel*')) active @endif">
                    <a href="#" class='sidebar-link'>
                ...
                <li
                    class="sidebar-item  @if(request()->routeIs('pengajar*')) active @endif ">
                    <a href="{{ route('pengajar.index') }} " class='sidebar-link' >
                        <i class="bi bi-people-fill"></i>
                        <span>Pengajar</span>
                    </a>
                </li>
                ...
                <li class="sidebar-title">Pengajar</li>
                <li
                    class="sidebar-item ">
                    <a href="#" class='sidebar-link' >
                        <i class="bi bi-clipboard-check"></i>
